...
| Analyze multi-session trends | [`paper_session_trends.md`](paper_session_trends.md) |
...
| [`paper_session_trends.md`](paper_session_trends.md) | Multi-session trend analyzer for recent history, status drift, recurring warnings, metrics, and symbol concentration. |
