# Real-data validation runbook (run in YOUR Codespace)
...
> Paper/demo only. No live trading, no `order_send`. These commands read market
> data and write reports; they never place orders.
...
git push origin claude/forex-scanner-edge-metrics-u68dk9
